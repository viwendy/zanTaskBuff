...
class IndexController extends HomeBaseController{
    ...
    public function index()
    {
        ...
        $map = array();
        $map['status'] = 1;
        $task_list = M('task')->field('id,title,level,price,create_time,max_num,apply_num,max_num-apply_num as leftnum, tasklb,task_require,video_url,end_time')->where($map)->order('id desc')->limit(800)->select();
