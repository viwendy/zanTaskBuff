...
<div class="login">
    <form class="submit-ajax" action="<?php echo U('login');?>">
        ...
        <div class="login-form">
            ...
            <!--	<p style="width: 80%;margin-left: 10%;margin-bottom: 0px;height: 30px;line-height: 30px;text-align: right;margin-top: -5px;font-weight: bold;color: #1fb2f6;margin-bottom: 10px;">忘记密码联系客服</p>-->
            
            
            <div class="login-inp" style="border: none;background: #1fb2f6;"><button type="submit" class="submit">立即登录</button></div>
        </div>
        
        <a href="<?php echo U('reg');?>">
        	<p style="width: 150px;height: 60px;line-height: 60px;margin: 66px auto 0; color: #1fb2f6; "> <span style="width: 20px;height: 20px;border: 1px #1fb2f6 solid;display: inline-block;margin: 20px 6px 20px 40px;text-align: center;float: left;line-height: 20px;border-radius: 20px;text-align: center;color: #1fb2f6;">→</span> 去注册</p>
        </a>
